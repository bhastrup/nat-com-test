...
#SBATCH --partition=sm3090_devel # a100 # sm3090el8
#SBATCH -N 1         # 1 node per job
#SBATCH -n 8         # 8 MPI processes per job
#SBATCH --ntasks-per-node=8
#SBATCH --time=0-08:00:00
#SBATCH --gres=gpu:1 # RTX3090
#SBATCH --output=slurm_outputs/analyse/exp2/feedback_ent15/FV/seed_%A_%a.out
#SBATCH --error=slurm_outputs/analyse/exp2/feedback_ent15/FV/seed_%A_%a.err
