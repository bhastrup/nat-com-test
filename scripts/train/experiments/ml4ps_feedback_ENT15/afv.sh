...
#SBATCH --output=slurm_outputs/train/feedback_ent15/afv_%j.out  # %j gives SLURM job ID
#SBATCH --error=slurm_outputs/train/feedback_ent15/afv_%j.err   # %j gives SLURM job ID


# Pass the arguments from the bash script to the Python script
python scripts/train/experiments/ml4ps_feedback_ENT15/afv.py