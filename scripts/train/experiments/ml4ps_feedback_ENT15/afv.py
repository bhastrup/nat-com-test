...
def main() -> None:
    ...
    # load_model = 'pretrain_runs/final-ent15-AFV/seed_1/models/pretrain_run-1_steps-28720.model'
    load_model = 'pretrain_runs/final-ent15-AFV/seed_1/models/pretrain_run-1_steps-29400.model'
    load_latest = False
    use_old_config = True
