...
# Deprecated: use src.tools.config.str2bool and src.tools.config.default_config instead.
from src.tools.config import str2bool  # noqa: F401 — re-exported for backward compatibility
