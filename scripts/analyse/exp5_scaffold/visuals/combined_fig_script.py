...
class ImageGridExp1:
    ...
    def draw_lines(self, i):
        ...
        if i < self.n_rows - 1:
            self.draw.line(
                ...
                width=self.line_width * (4 if i == 1 else 1),
                fill="red" if i == 1 else self.line_color,
            )
    ...
    def plot_histograms(self):
        ...
        for i in range(self.n_rows):
            ...
            ax.set_title(f"{pretty_formula}", fontsize=26, color=text_color, pad=15)
            ...
            legend = ax.legend(frameon=False, fontsize=18, loc="upper right")
    ...
    def draw_outer_box(self):
        ...
        self.draw.rectangle((0, 0, num_pixels_x, num_pixels_y), fill=None, outline="red", width=7)
...
if __name__ == "__main__":
    ...
    model_names = {
        ...
        # "30500": {
        #     "data_folder": "monday-30k-dip-30500",
        #     "model_obj": "pretrain_run-0_steps-30500.model",
        #     "visuals_dir": "exp5_black_dipole_relaxed_monday-30k-dip-30500"
        # }
        # "30600": {
        #     "data_folder": "monday-30k-dip-30600",
        #     "model_obj": "pretrain_run-0_steps-30600.model",
        #     "visuals_dir": "exp5_black_dipole_relaxed_monday-30k-dip-30600"
        # }
        # "30800": {
        #     "data_folder": "monday-30k-dip-30800",
        #     "model_obj": "pretrain_run-0_steps-30800.model",
        #     "visuals_dir": "exp5_black_dipole_relaxed_monday-30k-dip-30800"
        # }
        "Finetuned": {
        ...
        # "31000": {
        #     "data_folder": "monday-30k-dip-31000",
        #     "model_obj": "pretrain_run-0_steps-31000.model",
        #     "visuals_dir": "exp5_black_dipole_relaxed_monday-30k-dip-31000"
        # }
        ################################################################################
        # "31000": {
        #     "data_folder": "thursday-new-31000",
        #     "model_obj": "pretrain_run-0_steps-31000.model",
        #     "visuals_dir": "exp5_black_dipole_relaxed_thursday-new-31000"
        # },
        # "32000": {
        #     "data_folder": "thursday-new-32000",
        #     "model_obj": "pretrain_run-0_steps-32000.model",
        #     "visuals_dir": "exp5_black_dipole_relaxed_thursday-new-32000"
        # }
        # "33000": {
        #     "data_folder": "thursday-new-33000",
        #     "model_obj": "pretrain_run-0_steps-33000.model",
        #     "visuals_dir": "exp5_black_dipole_relaxed_thursday-new-33000"
        # }
    }
    ...
    output_file_name = build_comparison_image_name(
        prefix="image_grid_", bg_color_str=bg_color_str, model_names=model_names
    )
