...
def main() -> None:
    ...
    # load_model = 'pretrain_runs/final-ent15-AV/seed_0/models/pretrain_run-0_steps-28980.model'
    load_model = 'pretrain_runs/final-ent15-AV/seed_0/models/pretrain_run-0_steps-37050.model'
    load_latest = False
    use_old_config = True
