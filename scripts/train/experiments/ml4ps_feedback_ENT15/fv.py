...
def main() -> None:
    ...
    #load_model = 'pretrain_runs/final-ent15-FV/seed_1/models/pretrain_run-1_steps-24000.model'
    # load_model = 'pretrain_runs/final-ent15-FV/seed_1/models/pretrain_run-1_steps-33000.model'
    load_model = 'pretrain_runs/final-ent15-FV/seed_2/models/pretrain_run-2_steps-29240.model'
    load_latest = False
    use_old_config = True
