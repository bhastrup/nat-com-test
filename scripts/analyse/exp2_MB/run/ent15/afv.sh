...
#SBATCH --partition=a100_week # sm3090_devel #a100 # sm3090el8
#SBATCH -N 1         # 1 node per job
#SBATCH -n 8         # 8 MPI processes per job
#SBATCH --ntasks-per-node=8
#SBATCH --time=0-08:00:00
#SBATCH --gres=gpu:1 # RTX3090
#SBATCH --output=slurm_outputs/analyse/exp2/feedback_ent15/AFV/seed_%A_%a.out
#SBATCH --error=slurm_outputs/analyse/exp2/feedback_ent15/AFV/seed_%A_%a.err
#SBATCH --array=0-2  # Array indices for three jobs (seed_0, seed_1, seed_2)
